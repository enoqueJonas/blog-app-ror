  ...
  describe 'post show page' do
    before(:each) do
      ...
      @post = Post.create(title: 'post job', text: 'Job Searching
        ...
        Sed feugiat semper ex,
        rutrum dictum diam euismod sit amet. Maecenas vitae urna metus.
        Fusce tempor facilisis scelerisque. Vivamus fermentum,
        felis eu dapibus consectetur, lectus enim congue est,
        lacinia eleifend lorem ex nec elit. Suspendisse leo purus,
        euismod at laoreet id, bibendum sed lorem. Sed egestas,
        massa a placerat luctus, arcu velit euismod velit,
